...
const CompetitionLayout = () => {
  ...
  const [selectedStock, setSelectedStock] = useState(['AAPL', 'GOOGL', 'AMZN']);
  ...
  useEffect(() => {
    ...
    setMarketData([
      { date: new Date('2021-01-01'), symbol: 'AAPL', price: 150 },
      { date: new Date('2021-01-02'), symbol: 'GOOGL', price: 2800 },
      { date: new Date('2021-01-03'), symbol: 'AMZN', price: 3500 },
      // 更多模拟数据
    ]);
  }, []);
            ...
            <div className="market-display d-flex" style={{ flexDirection: 'row', alignItems: 'end' }}>
              <div className="stock-info" style={{ backgroundColor: 'transparent', flex: '1', padding: '1em' }}>
                <div style={{ backgroundColor: 'white', color: 'black' }}>
                  <CandlestickChart data={filteredMarketData} />
                </div>
              </div>
              <div className="report" style={{ flex: "1", padding: '1em' }}>
                <FinancialReport selectedStock={currentStock}
